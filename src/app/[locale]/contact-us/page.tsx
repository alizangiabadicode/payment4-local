...
import { ClockIcon, EmailIcon, Instagram, Linkedin, LocationIcon, PhoneIcon, X, Youtube } from "../../../icons/svg";
...
const ContactUs = () => {
    ...
    return (
        <div style={{ direction }} className="flex flex-col gap-y-[64px] md:gap-y-[88px] mb-[100px] md:mt-[50px]">
            <Snackbar isOpen={isOpen} onClose={() => setIsOpen(false)} message={t("successTicket")} />
          ...
          text-[18px] md:text-[24px] font-bold`}
            ...
            <div className="md:hidden flex flex-col gap-y-[24px] mx-[20px]">
             ...
             text-[16px] font-bold`}
              ...
              `}
                            >
                                {i18n.language !== "fa" ? t("openTime") : "شنبه تا چهارشنبه :‌۹ صبح تا ۱۶:۳۰ عصر"}
                            </p>
                        </div>
                        {i18n.language === "fa" && (
                            <>
              ...
              text-[16px] font-bold`}
                                    ...
                                    <p className="text-[12px]">
                                        تهران، بلوار پژوهش، پارک علم و فناوری دانشگاه تربیت مدرس، مرکز نوآوری زرین
                                    </p>
                                </div>
                            </>
                        )}
        ...
        justify-center px-[15px]"
            ...
            <div className="flex flex-col gap-10 items-center md:flex-row justify-center px-[30px]">
                ...
                <div className=" md:px-0">
                    <Image className="block" width={487} height={487} src={"/images/map-img.png"} alt="map" />
                    {/* <Image
