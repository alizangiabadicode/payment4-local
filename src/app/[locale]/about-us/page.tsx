    ...
    >
      <div className="flex flex-col items-center container mt-[40px]">
        <div className="flex flex-col items-center max-w-[822px]">
          ...
          <div
            className="px-5 md:px-0 grid grid-rows-1 grid-cols-3 
          md:grid-cols-3  
          justify-items-center gap-[50px] mt-[40px] mb-[80px] md:mb-[90px]"
          >
        ...
        items-center gap-y-5 mb-[30px] md:mb-[100px]"
          ...
          <div className="px-5 md:px-3 flex flex-col gap-y-5 mt-5 items-center">
            ...
            <div
              className="flex flex-col gap-y-5 md:grid grid-cols-2 
            md:gap-x-[95px] md:gap-y-[67px]"
            >
              {reasonsToChoosePayment4.map((item) => (
                <div key={item.title} className="flex flex-col gap-y-[10px]">
